...
# ==============================
# 三种场景（模拟真实比赛条件）：
# 1. 开关面板：3个灯（红/白/绿）+ 对应开关，随机亮1个灯（官方说明书 2026-08-17）
...
def gen_switch_panel(light_idx=None, n=6, prefix="panel_light"):
    ...
    for i in range(n):
        ...
        # 三个灯（水平排布，参考官方说明书：红白绿）
        light_colors = [(200, 60, 60), (150, 150, 150), (60, 180, 60)]  # 灭灯色
        lit_colors = [(255, 60, 60), (255, 255, 255), (60, 255, 60)]    # 亮灯色
